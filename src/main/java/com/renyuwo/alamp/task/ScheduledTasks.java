	...
	public void doSomething()
		...
		if (workOrderL.size() > 0) {
			...
			for (WorkOrder workOrder : workOrderL) {
				...
				postPam.append("logistics_interface=" + URLEncoder.encode(datastr.toString(), "utf-8") + "&data_digest="
						+ URLEncoder.encode(newmd5Str.toString(), "utf-8") + "&type=offline&clientId="
						+ DataTrans.E_ClientId);
